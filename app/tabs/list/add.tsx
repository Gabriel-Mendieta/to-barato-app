...
export default function AddToListScreen() {
    ...
    // Aquí `selectedProducts` ya lleva su campo `prices`
            ...
            <TouchableOpacity
                ...
                onPress={() =>
                    router.push({
                        ...
                        params: {
                            items: encodeURIComponent(JSON.stringify(selectedProducts)),
                        },
                    })
                }
            >
