...
/**
 * Web/static-render fallback. Native resolves BottomSheetCompat.native.tsx,
 * keeping @gorhom/bottom-sheet out of Expo's Node renderer.
 */
...
export function BottomSheetBackdrop(_props: any) {
  return null;
}
